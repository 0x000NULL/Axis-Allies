...
export const wasmengine_aiNextAction: (a: number, b: number, c: number) => [number, number];
export const wasmengine_aiPlayTurn: (a: number, b: number, c: number) => [number, number];
export const wasmengine_canUndo: (a: number) => number;
export const wasmengine_checkVictory: (a: number) => [number, number];
export const wasmengine_createSaveFile: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const wasmengine_currentPhase: (a: number) => [number, number];
export const wasmengine_currentPower: (a: number) => [number, number];
...
export const wasmengine_loadSaveFile: (a: number, b: number) => [number, number, number];
...
export const wasmengine_turnNumber: (a: number) => number;
